...
export default function (context) {
     $(document).on('click', '#add-custom-engraving-button', () => {
        const line1 = $('#add-custom-engraving .form-field  input[name=line1]').val();
        const line2 = $('#add-custom-engraving .form-field  input[name=line2]').val();
